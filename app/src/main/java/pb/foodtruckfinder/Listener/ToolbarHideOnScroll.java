package pb.foodtruckfinder.Listener;
 ...
 */
public class ToolbarHideOnScroll extends RecyclerView.OnScrollListener {
    ...
    public ToolbarHideOnScroll(View toolbarContainer, View toolbar, View lastToolbarView) {
        this(toolbarContainer, toolbar, lastToolbarView, null);
    }

    public ToolbarHideOnScroll(View toolbarContainer, View toolbar, View lastToolbarView, View parallaxScrollingView) {
